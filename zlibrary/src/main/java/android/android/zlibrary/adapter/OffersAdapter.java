...
public class OffersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OffersAdapter(Context context, List<VenueListModel> dataSet) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EMPTY)
            viewHolder = new OffersAdapter.ViewHolderEmpty(LayoutInflater.from(context).inflate(R.layout.recycler_item_empty_view, parent, false));
        else
            viewHolder = new OffersAdapter.ViewHolderVenue(LayoutInflater.from(context).inflate(R.layout.recycler_item_venue_cluster_list, parent, false));
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_EMPTY: {
                OffersAdapter.ViewHolderEmpty viewHolderEmpty = (OffersAdapter.ViewHolderEmpty) holder;
            ...
            case VIEW_TYPE_VENUE: {
                if (position >= 0 && position < dataSet.size()) {
                    OffersAdapter.ViewHolderVenue viewHolderVenue = (OffersAdapter.ViewHolderVenue) holder;
