...
public class VenuesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VenuesAdapter(Context context, List<VenueListModel> dataSet) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EMPTY)
            viewHolder = new VenuesAdapter.ViewHolderEmpty(LayoutInflater.from(context).inflate(R.layout.recycler_item_empty_view, parent, false));
        else
            viewHolder = new VenuesAdapter.ViewHolderVenue(LayoutInflater.from(context).inflate(R.layout.recycler_item_venue_cluster_list, parent, false));
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_EMPTY: {
                VenuesAdapter.ViewHolderEmpty viewHolderEmpty = (VenuesAdapter.ViewHolderEmpty) holder;
            ...
            case VIEW_TYPE_VENUE: {
                if (position >= 0 && position < dataSet.size()) {
                    VenuesAdapter.ViewHolderVenue viewHolderVenue = (VenuesAdapter.ViewHolderVenue) holder;
